...
<head>
    ...
    <style>
        ...
        * { 
        ...
        .room-image-frame[data-asset="room-std"] { background-image: url('Kaguya.png'); }
        .room-image-frame[data-asset="room-sup"] { background-image: url('Kaguya.png'); }
        .room-image-frame[data-asset="room-vil"] { background-image: url('Kaguya.png'); }
        .room-image-frame[data-asset="room-pre"] { background-image: url('Kaguya.png'); }
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="top-action-bar">
                ...
                <% if (isLoggedIn) { %>
                    <a href="home.php?action=logout" class="action-icon-btn logout-accent" title="Log Out">
            ...
            <div class="auth-central-card">
                <h2 class="auth-card-title">Login</h2>
                    ...
                    <input type="text"
                    name="username"
                    class="form-input-control <%= loginError != null ? "input-error-state" : "" %>"
                   ...
                   required>
                    ...
                    Don't have an account?
                        <a href="usersregistration.jsp">Register</a>
                    </div>
                </div>
            </div>
        </main>
