...
<head>
    ...
    <title>Olivia's Events Place - Premier Room</title>
    ...
    <style>
        ...
        * {
        ...
        .total-display-wrapper {
            ...
            align-items: center;
            justify-content: space-between;
            border-top: 2px dashed rgba(16, 67, 115, 0.2);
            padding-top: 15px;
            margin-top: 10px;
        }
...
<body>
    ...
    <div class="container">
        <aside class="sidebar" id="sidebar">
            <button class="sidebar-toggle-embed" id="menuToggleBtn">
        ...
        <main class="main-content">
            <div class="top-action-bar">
                <a href="../book.jsp" class="action-icon-btn">
                    <i class="fa-solid fa-arrow-left"></i>
                </a>
                <a href="../home.jsp" class="action-icon-btn">
                    <i class="fa-solid fa-house"></i>
                </a>
            </div>
            ...
            <div class="booking-wrapper">
                <div class="header-section">
                    ...
                    <h2 class="title-room-type">Premier Room</h2>
                </div>
                
                <form action="<%= request.getContextPath() %>/processBooking" method="POST" id="bookingForm">
                    <input type="hidden" name="room_type" value="Premier Room">
                    ...
                    <div class="workspace-grid">
                        <div class="selection-pane">
                            ...
                            <div class="calculation-card">
                                 <input type="hidden" name="roomType" value="Premier Room">
                                <div class="pax-row">
                                ...
                                <p class="selection-meta-text">Your Choosing (Premier Room) Maximum: 3 persons</p>

                                <div class="total-display-wrapper">
                                    <span class="total-title">Total:</span>
                                    <div class="total-amount-box">₱ 10,000</div>
                                </div>
                            </div>

                            <ul class="amenities-list">
                                <li>Premium experience for couples or small family (up to 3 pax)</li>
                                <li>Spacious king bed</li>
                                <li>Airconditioning + ceiling fan</li>
                                <li>43" LED TV with cable channels</li>
                                <li>Hot & cold rain shower</li>
                                <li>Mini refrigerator + coffee machine</li>
                                <li>Work desk with lamp</li>
                                <li>Free WiFi</li>
                                <li>Bathrobe & premium toiletries</li>
                        ...
                        <div class="media-pane">
                            ...
                            <div class="rate-indicator-bar">
                                Weekdays: ₱ 10,000 / Weekends / Holiday: ₱ 10,000
                            </div>
