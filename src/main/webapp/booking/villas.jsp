...
<head>
  ...
  <title>Olivia's Events Place - Villas</title>
    ...
    <main class="main-content">
      ...
      <div class="booking-wrapper">
        <div class="header-section">
          ...
          <h2 class="title-room-type">Villas</h2>
        </div>
        
        <form action="<%= request.getContextPath() %>/processBooking" method="POST" id="bookingForm">
          <input type="hidden" name="room_type" value="Villas">
          ...
          <div class="workspace-grid">
            <div class="selection-pane">
              ...
              <div class="calculation-card">
                <input type="hidden" name="roomType" value="Villas">
                <div class="pax-row">
                ...
                <p class="selection-meta-text">Your Choosing (Villas) Maximum: 6 persons</p>

                <div class="total-display-wrapper">
                  <span class="total-title">Total:</span>
                  <div class="total-amount-box" id="total_price_box">₱ 8,000</div>
                </div>
              </div>

              <ul class="amenities-list">
                <li>Spacious for families or groups (up to 6 pax)</li>
                <li>Separate living and dining area</li>
                <li>2 airconditioning units</li>
                <li>50" LED TV + 32" TV in bedroom</li>
                <li>Hot & cold shower (with bathtub)</li>
                <li>Mini kitchen with basic cookware</li>
                <li>Refrigerator + microwave</li>
                <li>Private balcony with pool/garden view</li>
            ...
            <div class="media-pane">
              ...
              <div class="rate-indicator-bar">
                Weekdays: ₱ 8,000 / Weekends / Holiday: ₱ 9,000
              </div>
