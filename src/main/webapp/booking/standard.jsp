<%-- 
    Document   : standard
    Created on : Jun 5, 2026, 6:49:06 AM
...
<head>
  ...
  <title>Olivia's Events Place - Standard Room</title>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .loader-overlay {
      ...
      background-color: rgba(15, 44, 89, 0.95); z-index: 99999;
    ...
    .sidebar-toggle-embed {
      position: absolute; top: 15px; left: 20px; background: transparent; border: none;
      font-size: 24px; color: var(--brand-primary-color); cursor: pointer; z-index: 110;
    }
    ...
    .nav-item { 
      display: flex; align-items: center; gap: 15px; padding: 12px 20px; text-decoration: none; font-weight: 600; 
      color: var(--brand-primary-color); font-size: 16px; border-bottom: 1.5px solid var(--brand-primary-color); cursor: pointer;
    ...
    .main-content {
      flex: 1; background: linear-gradient(135deg, var(--bg-gradient-start) 0%, var(--bg-gradient-mid) 50%, var(--bg-gradient-end) 100%);
      display: flex; flex-direction: column; padding: 30px 40px; overflow-y: auto; position: relative;
    }

    .top-action-bar { position: fixed; top: 30px; right: 40px; display: flex; gap: 12px; z-index: 500; }
    .action-icon-btn { 
      background-color: var(--brand-primary-color); color: white; width: 45px; height: 45px; border-radius: 50%; 
    ...
    .datetime-bar i { font-size: 18px; }
    .datetime-inputs { display: inline-flex; align-items: center; gap: 5px; background: transparent; border: none; color: white; font-family: inherit; font-size: 15px; }
    .datetime-inputs input, .datetime-inputs select { background: white; color: #1e4b7a; border: none; border-radius: 4px; padding: 2px 6px; font-weight: 700; outline: none; text-align: center; }
    ...
    .pax-label { display: flex; flex-direction: column; }
    .pax-label span { font-size: 11px; color: #666; font-weight: 500; }
    ...
    .counter-val { width: 50px; text-align: center; font-size: 18px; font-weight: 700; border: none; background: transparent; color: var(--brand-primary-color); outline: none; }
    ...
    .amenities-list li::before { content: "•"; color: #1e3a8a; font-size: 20px; line-height: 1; }

    .media-pane { display: flex; flex-direction: column; align-items: center; }
    .showcase-frame { width: 100%; aspect-ratio: 1.45 / 1; border: 4px solid #000000; border-radius: 12px; box-shadow: 8px 8px 0px var(--shadow-color); background-size: cover; background-position: center; margin-bottom: 12px; background-color: #fff; }
    ...
    .submit-booking-now { 
      width: 100%; max-width: 260px; background-color: #0284c7; color: white; border: none; border-radius: 50px; 
      padding: 12px 0; font-size: 18px; font-weight: 700; cursor: pointer; box-shadow: 0 4px 10px rgba(0,0,0,0.15); 
      transition: all 0.2s ease; text-transform: capitalize; text-align: center; text-decoration: none;
    }
    ...
    <main class="main-content">
      ...
      <div class="booking-wrapper">
        <div class="header-section">
          ...
          <h2 class="title-room-type">Standard Room</h2>
        </div>
          ...
          <div class="workspace-grid">
            ...
            <div class="selection-pane">
              ...
              <div class="datetime-bar">
                ...
                <div class="datetime-inputs">
                  <select name="booking_month" id="booking_month">
              ...
              <div class="calculation-card">
                ...
                <p class="selection-meta-text">Your Choosing (Standard Room) Maximum: 2 persons</p>

                <div class="total-display-wrapper">
                  <span class="total-title">Total:</span>
                  <div class="total-amount-box" id="total_price_box">₱ 3,000</div>
                </div>
              </div>

              <ul class="amenities-list">
                <li>1 Queen Bed</li>
                <li>Comfortable for couples and solo travelers</li>
                <li>Airconditioning + ceiling fan</li>
                <li>32" LED TV with cable channels</li>
                <li>Hot & cold shower</li>
                <li>Free WiFi</li>
                <li>Towels & basic toiletries included</li>
              </ul>
            </div>
            ...
            <div class="media-pane">
              ...
              <div class="rate-indicator-bar">
                Weekdays: ₱ 3,000 / Weekends / Holiday: ₱ 4,000
              </div>
